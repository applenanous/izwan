/*Description: This file runs Instantaneous Test 2b.
...
#define YES 1
#define NO 0
#define timeOFF_start	500
#define timeOFF_step 	500	// milliseconds
#define timeOFF_max		20000	// milliseconds

const int relayPin = 17; 	// Set GPIO pin 17
void instantaneous_AC_test2b (int test_cycle, status *testStatus);
...
int main (void)
{
	...
	printf("Instantaneous Test 2b is running! Press CTRL+C to quit. \n\n");
	do {
	...
	instantaneous_AC_test2b (test_cycle, &testStatus);
