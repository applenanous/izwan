/*Description: This file runs Instantaneous Test 3.
...
#define YES 1
#define NO 0
#define timeOFF_start	20
#define timeOFF_step 	20	// milliseconds
#define timeOFF_max		500	// milliseconds

const int relayPin = 17; 	// Set GPIO pin 17
void instantaneous_AC_test3 (int test_cycle, status *testStatus);
...
int main(void)
{
	...
	printf("Instantaneous Test 3 is running! Press CTRL+C to quit. \n\n");
	do {
	...
	instantaneous_AC_test3 (test_cycle, &testStatus);
