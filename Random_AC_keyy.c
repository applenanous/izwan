...
//	pthread_create(&thread_scankeyy, NULL, (void*) scan_key, &testStatus);
	pthread_create(&thread_scankeyy, NULL, (void*) scan_log, &testStatus);
	...
	pthread_join(thread_scankeyy, NULL);
	getch();
}
